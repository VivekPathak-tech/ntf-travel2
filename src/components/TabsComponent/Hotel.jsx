    ...
    <div className='flex justify-around gap-5'>
            ...
            >
              <Box sx={styles.travelerCounter}>
                <Typography variant="h6" fontWeight="600" marginBottom="8px"> {/* Reduced margin-bottom */}
                  Rooms and Guests
                </Typography>
                {rooms.map((room, index) => (
                  <Box key={room.id} sx={{ marginBottom: "12px" }}> {/* Reduced margin-bottom */}
                    <Typography variant="body1" fontWeight="500" marginBottom="4px"> {/* Reduced margin-bottom */}
                      Room {index + 1}{" "}
                      {rooms.length > 1 && (
                        <DeleteIcon
